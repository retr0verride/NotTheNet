...
def test_parse_negotiate_detects_smb1_eternalblue_probe() -> None:
    ...
    version, dialects, eternalblue, message_id = session._parse_negotiate(data)
...
def test_parse_negotiate_extracts_smb2_message_id() -> None:
    ...
    version, dialects, eternalblue, parsed_message_id = session._parse_negotiate(bytes(data))
